...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    //private List<GameObject> ImagePlayer = new List<GameObject>();
    ...
    {
        EditProfile.toStatic.OnEditName();
    }
    ...
    public void OnEnterCreateRoomClicked()
    {
        ...
        if (roomNameInputField.text == "")
        {
            ...
            switch (randomName)
            {
                ...
                case 4: roomName = "อยากเสียเงินก็เข้ามา :)"; break;
            }
        }
    ...
    public override void OnRoomListUpdate(List<RoomInfo> roomList)
    {
        ...
        foreach (RoomInfo room in cachedRoomList.Values)
        {
           ...
           //roomListEntry.transform.Find("Img-profile").GetComponent<Image>().sprite = imgPlayer.GetComponent<Image>().sprite;
